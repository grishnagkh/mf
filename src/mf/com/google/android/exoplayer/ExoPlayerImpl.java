...
/* package */final class ExoPlayerImpl implements ExoPlayer {
	...
	public ExoPlayerImpl(int rendererCount, int minBufferMs, int minRebufferMs) {
		...
		internalPlayer = new ExoPlayerImplInternal(eventHandler, playWhenReady,
				rendererEnabledFlags, minBufferMs, minRebufferMs);
	}
	...
	public int getBufferedPercentage() {
		...
		return bufferedPosition == ExoPlayer.UNKNOWN_TIME
				|| duration == ExoPlayer.UNKNOWN_TIME ? 0
